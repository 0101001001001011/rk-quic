...
/// whether the transport exists is asking a question, and a question is
/// answered, not raised.
enum NativeLoadOutcome {
  ...
  /// report to anyone; the browser is the *client* of this endpoint, not its
  /// host.
  unsupportedPlatform,
  ...
  /// collision — some other `rk_quic` on the loader path.
  symbolMissing,
...
/// The answer to "is there a native transport here, and which one".
///
